// Demo helper functions used by the `demo` CLI subcommand.
// Pulled out of main.rs to keep the entry point thin.

use std::time::{Duration, Instant};
use crate::market_data::csv_loader::HistoricalDay;
use crate::models::bs_mod::black_scholes_call;
use crate::models::heston::{HestonParams, HestonMonteCarlo, MonteCarloConfig};
use crate::models::heston_analytical::{
...
use crate::strategies::{StrategyRegistry, vol_mean_reversion::VolMeanReversion};
use crate::calibration::{create_mock_market_data, calibrate_heston, CalibParams};
use crate::utils::action_table_out;
use crate::utils::pnl_output;

pub fn demo_market_analysis(history: &[HistoricalDay], n_days: usize, sigma: f64, load_time: Duration) {
...
pub fn demo_analytical_pricing(
    current_price: f64,
...
pub fn demo_monte_carlo(heston_params: HestonParams, atm_strike: f64, carr_madan_time: Duration) -> f64 {
    println!("\n{}", "=".repeat(70));
...
pub fn demo_strategy_signals(symbol: &str, current_price: f64, sigma: f64, heston_params: &HestonParams) {
    println!("\n{}", "=".repeat(70));
...
pub fn demo_calibration(current_price: f64, rate: f64) {
    println!("\n{}", "=".repeat(70));
...
pub fn demo_summary(speedup: f64) {
    println!("\n{}", "=".repeat(70));
